...
static int jl2xxx_downshift_static_op_set(struct phy_device *phydev)
{
	struct jl2xxx_priv *priv = phydev->priv;
	int err;
...
static int jl2xxx_rgmii_static_op_set(struct phy_device *phydev)
{
	struct jl2xxx_priv *priv = phydev->priv;
	int err;
...
static int jl2xxx_clk_static_op_set(struct phy_device *phydev)
{
	struct jl2xxx_priv *priv = phydev->priv;
	int err;
...
static int jl2xxx_slew_rate_static_op_set(struct phy_device *phydev)
{
	int err;
...
static int jl2xxx_rxc_out_static_op_set(struct phy_device *phydev)
{
	int err;
...
static int jl2xxx_work_mode_static_op_set(struct phy_device *phydev)
{
	struct jl2xxx_priv *priv = phydev->priv;
	int err;
...
static int jl2xxx_lpbk_static_op_set(struct phy_device *phydev)
{
	struct jl2xxx_priv *priv = phydev->priv;
	int err;
...
static int jl1xxx_mdi_static_op_set(struct phy_device *phydev)
{
	struct jl1xxx_priv *priv = phydev->priv;
	int err;
...
static int jl1xxx_rmii_static_op_set(struct phy_device *phydev)
{
	struct jl1xxx_priv *priv = phydev->priv;
	int err;
...
static int jl2xxx_patch_static_op_set(struct phy_device *phydev)
{
	int err;
